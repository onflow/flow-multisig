...
const envSettings = {
  mainnet: {
    ...
    "discovery.wallet": "https://fcl-ledger-web-git-authn-authz-locked-acct-0913-updates-onflow.vercel.app//mainnet/authn",
  ...
  testnet: {
    ...
    "discovery.wallet": "https://fcl-ledger-web-git-authn-authz-locked-acct-0913-updates-onflow.vercel.app/testnet/authn",
    "sdk.transport": httpSent,
