...
const envSettings = {
  mainnet: {
    ...
    "discovery.wallet": "fcl-ledger-oivj2vmqf-onflow.vercel.app/mainnet/authn", // (fcl-ledger-web branch) ledger-multi-account-authz
  ...
  testnet: {
    ...
    "discovery.wallet": "fcl-ledger-oivj2vmqf-onflow.vercel.app/testnet/authn", // (fcl-ledger-web branch) ledger-multi-account-authz
    "sdk.transport": httpSent,
